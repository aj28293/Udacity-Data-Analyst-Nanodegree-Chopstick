...
One great advantage of ipython notebooks is that you can document your data analysis using code, add comments to the code, or even add blocks of text using Markdown. These notebooks allow you to collaborate with others and share your work. For now, let's see some code for doing statistics.
    ...
    path = r'C:\Users\User\Desktop\Udacity\Chopstick\chopstick-effectiveness.csv'
...
#### 5. Which chopstick length performed the best for the group of thirty-one male junior college students?
    ...
    ￼
      ...
      File "<ipython-input-6-db0f7b3a6cd3>", line 12
        ￼
        ^
...
With the exception of 270mm, the plot shows a somewhat normal distribution with 240mm approximately the mean.  
...
#### 7b. Why?
The Food.Pinching.Efficiency of 26.32 at 240mm size chopstick is statistically significantly higher than the Food.Pinching.Efficiency at shorter and longer chopstick lengths. 
